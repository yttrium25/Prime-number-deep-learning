...
for i in range(iters_num):
    ...
    for key in ('W1', 'b1', 'W2', 'b2'):
        ...
        # network.params['W1'] 784*50配列 (i, j)成分:入力層のi番目のニューロン -> 隠れ層のj番目のニューロン　への重み
        # network.params['b1'] 1*50配列　j成分:入力層j番目のニューロン -> 隠れ層j番目のニューロン　へのバイアス
        # network.params['W2'] 50*10配列 (i, j)成分:入力層のi番目のニューロン -> 出力層j番目のニューロン　への重み
        # network.params['b2'] 1*10配列　j成分:隠れ層j番目のニューロン -> 出力層j番目のニューロン　へのバイアス
